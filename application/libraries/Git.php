...
class Git {
	...
	public function init($params){
		...
		$this->git_path = isset($params['git_path']) ? $params['git_path'] : '/usr/bin/git';
		
		$this->remote = isset($params['remote']) ? $params['remote'] : 'origin';
		$this->branch = isset($params['branch']) ? $params['branch'] : 'master';
		$this->user_group = isset($params['user_group']) ? $params['user_group'] : 'optospot';
		$this->user_name = isset($params['user_name']) ? $params['user_name'] : 'optospot';
